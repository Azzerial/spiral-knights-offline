...
import net.azzerial.sko.api.items.weapons.Bomb;
import net.azzerial.sko.api.items.weapons.Handgun;
import net.azzerial.sko.api.items.weapons.Sword;
import net.azzerial.sko.api.items.weapons.Weapon;
