...
package net.azzerial.sko.api.items.gears;

import net.azzerial.sko.api.items.Set;
...
import net.azzerial.sko.api.items.gears.components.StatusResistance;
import net.azzerial.sko.api.items.gears.components.DefenseStat;
...
public enum Helmet implements Gear {
    ...
    Helmet(String name, String description, StarLevel starLevel) {
        this.name = name;
